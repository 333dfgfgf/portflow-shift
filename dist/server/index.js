globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-4EC-3uGv.js","assets/leaflet-src-BbiSgxSs.js","assets/layout-segment-context-DVJzAZws.js"];
...
function getDraftSecret() {
	return "4c2cdade-8011-4c7a-864f-366fa015a312";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "19c1defa-d671-4edf-871a-bc1b52a7c18a";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "19c1defa-d671-4edf-871a-bc1b52a7c18a") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "19c1defa-d671-4edf-871a-bc1b52a7c18a",
		rootBoundaryId
	});
}
/**
...
var viewport = { themeColor: "#082f63" };
...
var __configHeaders = [];
var __publicFiles = new Set(["/brand/bluesync-logo.png", "/manifest.webmanifest"]);
