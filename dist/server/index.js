globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-CEP6hstU.js","assets/layout-segment-context-Cn-d_Zx2.js"];
...
function getDraftSecret() {
	return "91816d97-36a7-4c29-b71a-963b2c534b4b";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "f788058c-89d6-411d-a1a6-420ec975cc8a";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "f788058c-89d6-411d-a1a6-420ec975cc8a") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "f788058c-89d6-411d-a1a6-420ec975cc8a",
		rootBoundaryId
	});
}
/**
